...
| ----------------------- | -------------------------------------- | --------------------------------------------------------- |
| `noosphere` (prod)      | Real project memory at usenoosphere.ai | Browse/save project context, session summaries, decisions |
...
- **Always prefer `noosphere-dev` MCP tools** (browse, save, search, read) over
